 ...
 */
public class FlutterSerialCommunication implements FlutterPlugin, MethodCallHandler, ActivityAware, SerialInputOutputManager.Listener {
  private final SerialMessageHandler serialMessageHandler = new SerialMessageHandler();
  private final DeviceConnectionHandler deviceConnectionHandler = new DeviceConnectionHandler();
  ...
  public void onMethodCall(@NonNull MethodCall call, @NonNull Result result) {
    switch (call.method) {
      ...
      case "purgeHwBuffers": {
        purgeWriteBuffers = Boolean.TRUE.equals(call.argument("purgeWriteBuffers"));
        purgeReadBuffers = Boolean.TRUE.equals(call.argument("purgeReadBuffers"));
  ...
  public void onRunError(Exception e) {
    activity.runOnUiThread(this::disconnect);
  }
}
