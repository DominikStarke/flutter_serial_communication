...
/// Bindings for `src/third_party/libserialport/libserialport.h`.
///
/// Regenerate bindings with `dart run ffigen --config ffigen.yaml`.
///
class FlutterSerialCommunicationDesktopSupportBindings {
  /// Holds the symbol lookup function.
  final ffi.Pointer<T> Function<T extends ffi.NativeType>(String symbolName)
      _lookup;

  /// The symbols are looked up in [dynamicLibrary].
  FlutterSerialCommunicationDesktopSupportBindings(
      ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  FlutterSerialCommunicationDesktopSupportBindings.fromLookup(
...
final class sp_port extends ffi.Opaque {}

/// @struct sp_port_config
/// An opaque structure representing the configuration for a serial port.
final class sp_port_config extends ffi.Opaque {}

/// @struct sp_event_set
/// A set of handles to wait on for events.
final class sp_event_set extends ffi.Struct {
